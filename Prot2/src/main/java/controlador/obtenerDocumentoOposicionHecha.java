 ...
 * @author User
 */
@WebServlet(name = "obtenerDocumentoOposicionHecha", urlPatterns = {"/obtenerDocumentoOposicionHecha/*"})
public class obtenerDocumentoOposicionHecha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DocumentoOposicionHecha documento = documentoControl.findDocumentoOposicionHecha(idDocumento);
        ...
        /*if(bytes == null){
             bytes = ImagenProductoMng.getImagen(-1);
        }*/
        fos.write(bytes);
        fos.flush();
        fos.close();
